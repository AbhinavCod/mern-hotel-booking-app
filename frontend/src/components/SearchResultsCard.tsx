        ...
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded p-8 gap-8">
            ...
            <div className="grid grid-rows-[1fr_2fr_1fr]">
                <div>
                    ...
                    <Link className="text-2xl font-bold cursor-pointer" to={`/details/${hotel._id}`}>{hotel.name}</Link>
                </div>
                ...
                <div className="grid grid-cols-2 items-center whitespace-nowrap">
                    <div className="flex gap-1 items-center">
                        ...
                        <span className="text-sm">{hotel.facilities.length > 3 && `+${hotel.facilities.length -1} more`}</span>
                    </div>
